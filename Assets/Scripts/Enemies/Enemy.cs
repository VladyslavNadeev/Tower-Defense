...
public class Enemy : GameBehavior
{
    ...
    private void PrepareTurnRight()
    {
        ...
        _progressFactor = CHANGE_DIR_SPEED_MULTIPLIER / (Mathf.PI * 0.5f * (0.5f - _pathOffset));
    }
    ...
    private void PrepareTurnAround()
    {
        ...
        _progressFactor = CHANGE_DIR_SPEED_MULTIPLIER / (Mathf.PI * Mathf.Max(Mathf.Abs(_pathOffset), 0.2f));
    }
    ...
    public override void SetPaused(bool isPaused)
    {
        if (isPaused)
        {
            _tempSpeedFactor = _enemyView.SpeedFactor;
        }
