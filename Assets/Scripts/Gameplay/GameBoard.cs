...
public class GameBoard : MonoBehaviour
{
    ...
    public bool FindPath()
    {
        ...
        {
            if(t.Content.ContentType == GameTileContentType.Destination)
            {
                t.BecomeDestination();
    ...
    public void ForceBuild(GameTile tile, GameTileContent content)
    {
        ...
        if(content.ContentType == GameTileContentType.SpawnPoint)
        {
    ...
    {
        if(tile.Content.ContentType != GameTileContentType.Empty)
        {
            return false;
        }
    ...
    public void DestroyTile(GameTile tile)
    {
        ...
        if(tile.Content.ContentType == GameTileContentType.SpawnPoint)
        {
    ...
    public GameTileContentType[] GetAllContent => _tiles.Select(t => t.Content.ContentType).ToArray();
